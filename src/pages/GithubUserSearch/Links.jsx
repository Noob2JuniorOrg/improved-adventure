...
function Links() {
  ...
  return (
    <div className="flex flex-col tablet:flex-row desktop:ml-[150px]">
      <div className="tablet:flex tablet:flex-col tablet:w-1/2">
        <Link icon={mapIcon} value="San Francisco" />
        <Link icon={siteIcon} value="https://github.blog" />
      </div>
      <div className="tablet:flex tablet:flex-col tablet:w-1/2">
        <Link icon={twitterIcon} value="" />
        <Link icon={companyIcon} value="@github" />
      </div>
    </div>
  );
}
